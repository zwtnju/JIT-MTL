...
python run_mtl.py \
--model_type roberta \
--output_dir=./saved_models/eflmt/${model} \
--model_name_or_path=../model/${model} \
--do_train \
--do_test \
--run_expert_feature \
--mix_checkpoint \
--defect_code_representation_checkpoint ../checkpoint/line/${model}/checkpoint-best-f1/model.bin \
...
--dp_loss_weight 1 \
--dl_loss_weight 1 2>&1| tee run_eflmt_${model}.log